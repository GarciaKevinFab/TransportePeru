...
import { Truck, Loader2, MailCheck, AlertCircle } from 'lucide-react';
  ...
  <div className="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-6">
    <div className="w-full max-w-sm">
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        <Link to="/login" className="hover:text-slate-200 underline underline-offset-4">
          Volver al acceso
        </Link>
      </p>
    </div>
      ...
      <Marco>
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-400">
            Si <strong className="text-slate-200">{email}</strong> tiene una cuenta, le
